            ...
            {googleLoading ? (
              ...
              <div className="w-full flex justify-center">
                <button
                  ...
                  className="w-full max-w-[320px] py-2.5 bg-white hover:bg-slate-50 border border-slate-300 rounded text-xs font-bold text-slate-700 flex items-center justify-center space-x-2 shadow-xs transition-colors cursor-pointer"
                >
