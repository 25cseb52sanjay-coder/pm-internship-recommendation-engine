...
def test_adzuna_ai_recommendations_suite():
    print("\n======================================================================")
    print("  ADZUNA INTEGRATION STAGE 10: AI RECOMMENDATIONS ENGINE AUDIT TEST SUITE")
    print("======================================================================\n")
    ...
    # 2. Analyze Adzuna Opportunities in Recommendations Stream
    print("\n  [STEP 2] Verifying Adzuna opportunities appear in AI recommendations...")
    adz_recs = [r for r in recommendations if r["internship"].get("source") == "Adzuna"]
    print(f"    - Found {len(adz_recs)} real Adzuna opportunities in student AI recommendations stream.")
    assert len(adz_recs) > 0, "Adzuna real opportunities must appear in candidate AI recommendations"

    # 3. Verify Source Attribution & Apply URL Integrity
    print("\n  [STEP 3] Verifying source attribution, opportunity_type, and apply_url on Adzuna recommendations...")
    for rec in adz_recs[:5]:
        opp = rec["internship"]
        score = rec["score"]
        ...
        assert opp["source_name"] == "Adzuna Official API"
        assert opp["opportunity_type"] in ["JOB", "INTERNSHIP", "UNKNOWN"]
    ...
    print("\n======================================================================")
    print("  STAGE 10 ADZUNA AI RECOMMENDATIONS ENGINE AUDIT: PASSED (100% SUCCESS)")
    print("======================================================================\n")

if __name__ == "__main__":
    test_adzuna_ai_recommendations_suite()
