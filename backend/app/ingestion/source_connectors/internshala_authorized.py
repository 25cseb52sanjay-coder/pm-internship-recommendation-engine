...
class InternshalaAuthorizedConnector(BaseConnector):
    """
    Internshala Authorized Connector Stub (Google Antigravity Spec Specification).
    ...
    """
    def __init__(self):
        auth_status = "AUTHORIZED" if settings.INTERNSHALA_API_KEY else "NOT_CONFIGURED"
        super().__init__(
            source_name="Internshala Authorized Feed Connector",
